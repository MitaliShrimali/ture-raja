...
<a href="{{ url('packages/' . \Illuminate\Support\Str::slug($title)) }}" target="_blank" {{ $attributes->merge(['class' => 'relative flex-shrink-0 w-[280px] md:w-[350px] aspect-[3/4] group overflow-hidden rounded-[40px] shadow-premium cursor-pointer block']) }}>
