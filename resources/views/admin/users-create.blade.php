...
<div class="pb-16 text-[#1A1A24]" x-data="adminData()">
    ...
    <form action="{{ url('/admin/users/store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        ...
        <div x-show="role === 'SUPER ADMIN'" class="p-6 bg-orange-50/40 rounded-[32px] border border-orange-100/70 flex items-start gap-5 transition-all duration-300 shadow-sm" x-transition style="display: none;">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <label class="flex items-center gap-3 cursor-pointer group">
                            <input type="checkbox" name="permissions[]" value="{{ $key }}" class="w-5 h-5 rounded-full border border-gray-300 text-[#b13c0b] focus:ring-[#b13c0b]/20 focus:ring-offset-0 focus:outline-none transition-all">
