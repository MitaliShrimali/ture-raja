        ...
        <div class="lg:col-span-8 bg-white rounded-[32px] border border-border-soft p-8 space-y-8 shadow-sm">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="gst" x-model="gst" placeholder="18" class="w-full bg-[#F8F9FA] border-none rounded-2xl py-4 pl-6 pr-12 outline-none focus:ring-2 focus:ring-primary/20 transition-all font-semibold text-foreground" />
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="features" x-model="features" rows="4" placeholder="15 package listings&#10;15 Package Limit&#10;Priority Support" class="w-full bg-[#F8F9FA] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/20 transition-all font-semibold text-foreground resize-none"></textarea>
                </div>
