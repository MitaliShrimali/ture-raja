...
<div class="space-y-10 pb-12">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div class="space-y-2">
            <p class="text-xs font-bold text-primary uppercase tracking-widest">Admin / User Management</p>
            <h1 class="text-5xl font-black text-foreground tracking-tight">Admin User</h1>
