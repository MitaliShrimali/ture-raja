...
<head>
    ...
    <title>Admin Sign Up – TourRaja</title>
    ...
    <div class="hero-bg">
        ...
        <div class="max-w-5xl mx-auto px-6 pt-6 pb-4">
            <div class="navbar-pill rounded-full px-6 py-3 flex items-center justify-between">
                ...
                <a href="{{ url('/contact') }}"
                    class="hidden md:inline-flex items-center gap-2 bg-[#e85d26] hover:bg-[#d04d18] text-white text-[11px] font-bold uppercase tracking-wider px-5 py-2.5 rounded-full transition-all shadow-lg shadow-black/10">
                    Contact Admin
                </a>
        ...
        <div class="card-form bg-white w-full max-w-md p-8 md:p-10" x-data="{ remember: true }">
            ...
            <div class="flex items-center justify-center gap-5 mb-5">
                ...
                <button type="button" class="social-btn">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="#000">
                        <path
                            d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.53 4.08zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.32 2.32-2.13 4.47-3.74 4.25z" />
                    </svg>
                </button>
                <button type="button" class="social-btn">
            ...
            <form action="{{ url('/signup/submit') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required placeholder="Your email"
                        class="input-field" />
                </div>
                ...
                <div>
                    ...
                    <input type="password" name="password" required placeholder="Your password" class="input-field" />
                </div>
