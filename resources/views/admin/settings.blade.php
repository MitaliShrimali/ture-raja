    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div class="space-y-1">
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-3xl font-black text-gray-900 tracking-tight">Genaral Settings</h2>
            </div>
            <p class="text-sm text-gray-500 font-medium max-w-2xl leading-relaxed pl-9">
                Manage your agency's core identity, financial compliance, and global presence.
            </p>
        </div>
    </div>
