...
@section('admin_title', 'Packages Domestic')
...
<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div class="space-y-2">
            <h2 class="font-black text-foreground tracking-tight">Home Domestic Packages</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-[24px] p-6 shadow-sm border border-border-soft flex flex-col justify-center">
            ...
            <h3 class="text-3xl font-black text-foreground">India</h3>
        </div>
        ...
        <div @click.away="showAddModal = false; showEditModal = false" class="bg-white rounded-[40px] shadow-premium border border-border-soft max-w-lg w-full max-h-[90vh] flex flex-col">
            <div class="flex items-center justify-between border-b border-border-soft p-6 md:p-8 shrink-0">
                <div class="space-y-1">
                    ...
                    <p class="text-xs text-muted-text font-medium">Update the details for this domestic package.</p>
                </div>
            ...
            <form :action="showAddModal ? '{{ url('/admin/home-packages/store') }}' : '{{ url('/admin/home-packages/update') }}'" method="POST" enctype="multipart/form-data" class="p-6 md:p-8 overflow-y-auto space-y-6">
                ...
                <div class="space-y-4">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="title" x-model="editPkg.title" placeholder="e.g. Kashmir" required class="w-full bg-gray-50 border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/20 transition-all font-medium text-foreground shadow-sm">
                    </div>

                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-muted-text uppercase tracking-widest pl-1">Subtitle (Location)</label>
                        <input type="text" name="subtitle" x-model="editPkg.subtitle" placeholder="e.g. India" class="w-full bg-gray-50 border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/20 transition-all font-medium text-foreground shadow-sm">
                    </div>
