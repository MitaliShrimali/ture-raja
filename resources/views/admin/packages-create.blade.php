            ...
            <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="departure_city" placeholder="New Delhi" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#e85d26]/25 transition-all font-bold text-foreground text-sm" />
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="departure_state" placeholder="Delhi" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#e85d26]/25 transition-all font-bold text-foreground text-sm" />
                    </div>
