                            ...
                            <select name="agent" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 pr-10 outline-none focus:ring-2 focus:ring-[#e85d26]/25 transition-all font-bold text-gray-800 text-sm appearance-none">
                                ...
                                <optgroup label="Paid Agents">
                                    @foreach($paidAgents as $ag)
                                        <option value="{{ $ag->name }}">{{ $ag->name }}{{ $ag->agency_name ? ' (' . $ag->agency_name . ')' : '' }}</option>
                                    @endforeach
                                </optgroup>
            ...
            <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2 relative">
                        ...
                        <input type="text" name="departure_city" id="departureCity" placeholder="New Delhi" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#e85d26]/25 transition-all font-bold text-foreground text-sm" autocomplete="off" />
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="departure_state" id="departureState" placeholder="Delhi" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#e85d26]/25 transition-all font-bold text-foreground text-sm" />
                    </div>

                    <!-- Departure Country -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-1">Departure Country</label>
                        <input type="text" name="departure_country" id="departureCountry" placeholder="India" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#e85d26]/25 transition-all font-bold text-foreground text-sm" />
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="badge" placeholder="e.g. 25% Off" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-[#e85d26]/25 transition-all font-bold text-gray-800 text-sm" />
                    </div>
        ...
        <div class="space-y-8 mt-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div class="space-y-8">
                    ...
                    <!-- Essential Amenities -->
                    <div x-show="!brochureName" class="bg-white rounded-[32px] border border-border-soft p-8 space-y-6 shadow-sm">
...
<label class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl cursor-pointer hover:bg-gray-100/60 transition-all">
        ...
        <div class="flex items-center justify-between pt-8 border-t border-gray-100 mt-8">
            ...
            <div class="flex items-center gap-3 ml-auto">
                ...
                <button type="submit" class="px-8 py-3.5 text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-xl shadow-orange-700/20" style="background-color: #e85d26 !important; color: #ffffff !important;">
                    Save Package
                </button>
            </div>
        </div>
