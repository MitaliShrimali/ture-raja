                    ...
                    <div class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input type="text" name="landline" value="{{ $agent->landline }}" placeholder="e.g. +91-79-12345678" class="w-full bg-[#F5F5F5] border-2 border-transparent focus:border-primary/20 focus:bg-white rounded-2xl py-3.5 px-5 outline-none transition-all font-bold text-foreground text-sm">
                            </div>
                        </div>
