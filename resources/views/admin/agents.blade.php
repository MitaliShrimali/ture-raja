...
<div class="space-y-10 pb-12" x-data="{ tier: 'Premium', status: 'Active', showCustomPlanModal: false, customAgentSearch: '', customPlanTier: '', customSacHsn: '', customSaleType: 'Direct Sale' }">
    ...
    <!-- Onboard Agent Form -->
    <form id="agentForm" x-ref="agentForm" action="{{ url('/admin/agents/store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center gap-2 text-sm">
                            ...
                            <button type="button" @click="customAgentSearch = 'Global Trails LLC'" class="px-3 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full font-medium transition-colors">Global Trails LLC</button>
                            <button type="button" @click="customAgentSearch = 'Nomad Ventures'" class="px-3 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full font-medium transition-colors">Nomad Ventures</button>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 pt-4">
                        <button type="button" @click="document.getElementById('agentForm').submit()" class="flex-1 bg-primary hover:opacity-90 text-white py-4 rounded-2xl font-black text-lg transition-colors flex items-center justify-center gap-2">
