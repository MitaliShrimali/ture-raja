            ...
            <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="badge" value="{{ old('badge', $pkg->badge ?? '') }}" placeholder="e.g. 25% Off" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                    </div>
...
<label class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl cursor-pointer hover:bg-gray-100/60 transition-all">
                    ...
                    <div class="bg-gray-50 p-6 rounded-[32px] border border-gray-100 flex items-center justify-between gap-4 shadow-sm">
                        <div class="space-y-1">
                            ...
                            <p class="text-[10px] text-gray-400 font-medium">Select a single thumbnail banner for card listing.</p>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button type="button" class="px-4 py-2 bg-orange-50 hover:bg-orange-100 text-primary border border-orange-200 rounded-xl font-bold text-xs shadow-sm transition-all" @click="openGalleryModal('main')">
                                Choose from Gallery
                            </button>
                            <input type="hidden" name="image_url" id="image_url" />
                            <span class="text-xs text-gray-400 font-bold" x-text="previewUrl ? 'Image Selected' : 'No file chosen'"></span>
                        </div>
                    </div>
