    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-gray-100">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-gray-400 font-medium text-xs mt-0.5">Configure package details, upload brochures, and add gallery portfolio.</p>
            </div>
        </div>
    </div>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <!-- Package Validity -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-1">Package Expiry Date</label>
                        <div class="relative">
                            <i data-lucide="calendar" size="16" class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400"></i>
                            <input type="text" name="validity" x-model="validity" x-ref="validityPicker" placeholder="Select Expiry Date" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 pl-10 pr-4 outline-none focus:ring-2 focus:ring-[#e85d26]/25 transition-all font-bold text-foreground text-sm" />
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2 relative">
                        ...
                        <input type="text" name="departure_city" id="departureCity" placeholder="New Delhi" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" autocomplete="off" />
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="departure_state" id="departureState" placeholder="Delhi" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                    </div>

                    <!-- Departure Country -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-1">Departure Country</label>
                        <input type="text" name="departure_country" id="departureCountry" placeholder="India" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div class="relative">
                                <span class="absolute left-5 top-1/2 -translate-y-1/2 text-sm font-black text-gray-400" x-text="currency"></span>
                                <input type="number" step="0.01" name="old_price" x-model="old_price" placeholder="Old Price" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 pl-12 pr-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm line-through text-gray-500" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="w-full bg-[#F5F5F5] rounded-2xl p-4 flex flex-wrap items-center gap-2 border border-transparent focus-within:bg-white focus-within:ring-2 focus-within:ring-primary/25 transition-all">
                            ...
                            <input type="text" x-model="newKeyword" @keydown.enter.prevent="addKeyword()" @keydown.comma.prevent="addKeyword()" placeholder="Type keyword & enter/comma..." class="bg-transparent border-none outline-none text-xs font-bold text-gray-700 py-1 px-2 focus:ring-0" style="border: none !important; outline: none !important; box-shadow: none !important;" />
        ...
        <div class="space-y-8 mt-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div x-show="!brochureName" class="bg-white rounded-[28px] border border-gray-100 p-8 space-y-5 shadow-sm">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                ...
                <div class="space-y-8">
                    ...
                    <!-- Essential Amenities -->
                    <div x-show="!brochureName" class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
...
<label class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl cursor-pointer hover:bg-gray-100/60 transition-all">
        ...
        <div class="flex items-center justify-between pt-8 border-t border-gray-100 mt-8">
            ...
            <div class="flex items-center gap-3 ml-auto">
                <a href="{{ url('/agent/packages') }}" class="px-6 py-3.5 bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 rounded-2xl font-bold text-xs uppercase tracking-wider transition-all">
                    Discard
                </a>
                <button type="submit" class="px-8 py-3.5 bg-primary hover:bg-orange-600 text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-xl shadow-orange-700/20" style="background-color: #e85d26 !important; color: #ffffff !important;">
                    Save Package
                </button>
            </div>
        </div>
