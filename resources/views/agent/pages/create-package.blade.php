...
@section('content')
    ...
    <div class="space-y-8 pb-12" @itinerary-updated.window="itineraryContent = $event.detail" x-data="{ 
        ...
        <!-- Form Container -->
        <form id="packageMainForm" action="{{ route('agent.packages.store') }}" method="POST" enctype="multipart/form-data"
            class="space-y-10">
            @csrf
                        ...
                        <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm transition-all duration-300" x-show="!brochureName">
                            ...
                            <div class="space-y-4">
                                ...
                                <label
                                    ...
                                    <input type="checkbox" name="amenities[]" value="Breakfast Included"
                                        class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary/25 cursor-pointer" />
                                </label>
                                ...
                                <label
                                    ...
                                    <input type="checkbox" name="amenities[]" value="Travel Insurance"
                                        class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary/25 cursor-pointer" />
                                </label>
                                <label
                                    class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl cursor-pointer hover:bg-gray-100/60 transition-all">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <button type="button"
                                            class="w-full px-4 py-2 bg-orange-50 hover:bg-orange-100 text-primary border border-orange-200 rounded-xl font-bold text-xs shadow-sm transition-all"
