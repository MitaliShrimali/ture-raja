                ...
                <div x-show="!brochureName" class="flex-1 bg-white rounded-[28px] border border-gray-100 p-6 space-y-3 shadow-sm flex flex-col">
                    <div class="flex items-center gap-2">
                        ...
                        <h4 class="text-sm font-bold text-gray-800">Itinerary (Day-by-Day Plan)</h4>
                           <textarea id="itinerary-textarea" name="editorial_itinerary" rows="9" placeholder="Explain why this tour is unique..." class="w-full flex-1 bg-transparent border-none py-4 px-5 outline-none text-gray-700 text-sm resize-none"></textarea>                   </div>
                </div>
            </div>
