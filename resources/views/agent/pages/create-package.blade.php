...
<div class="space-y-8 pb-12" x-data="{ 
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-gray-100">
        ...
        <div class="flex items-center gap-3 shrink-0">
            <a href="{{ route('agent.my-packages') }}" class="px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 rounded-2xl font-bold text-xs uppercase tracking-wider transition-all">
                Discard
            </a>
            <button type="button" @click="step = 2" x-show="step === 1" class="px-6 py-3 bg-primary hover:bg-orange-600 text-white rounded-2xl font-bold text-xs uppercase tracking-wider transition-all flex items-center gap-2 shadow-lg shadow-orange-700/20" style="background-color: #e85d26 !important; color: #ffffff !important;">
                Save & Next <i data-lucide="chevron-right" size="14"></i>
            </button>
            <button type="submit" form="packageMainForm" x-show="step === 2" class="px-6 py-3 bg-primary hover:bg-orange-600 text-white rounded-2xl font-bold text-xs uppercase tracking-wider transition-all flex items-center gap-2 shadow-lg shadow-orange-700/20" style="background-color: #e85d26 !important; color: #ffffff !important;">
            ...
            <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="duration" x-model="duration" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="stock" x-model="stock" placeholder="20 Dec 2024 - 30 Mar 2025" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 pl-14 pr-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="badge" x-model="badge" placeholder="New Delhi" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                    </div>

                    <!-- Departure State -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-1">Departure State</label>
                        <input type="text" placeholder="Delhi" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                    </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-[28px] border border-gray-100 p-8 space-y-6 shadow-sm">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="excluded[]" rows="3" placeholder="Specific booking policies for this package..." class="w-full bg-[#F8F8F8] border-none rounded-2xl py-4 px-5 outline-none focus:ring-2 focus:ring-primary/15 transition-all text-sm text-gray-600 resize-none"></textarea>
                        </div>
                    </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex items-center justify-between gap-4">
                        <div class="space-y-1">
                            ...
                            <p class="text-xs text-gray-400 font-medium">Select a single thumbnail banner for card listing.</p>
                        </div>
                        <div class="flex items-center gap-3">
