...
<div class="space-y-8 pb-12" x-data="{ 
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-gray-100">
        <div class="flex items-center gap-4">
            <a href="{{ route('agent.my-packages') }}" class="p-3 bg-white hover:bg-gray-50 border border-gray-100 rounded-2xl transition-all shadow-sm text-gray-500 hover:text-primary">
    ...
    <div class="step-track-container max-w-4xl mx-auto py-6">
        ...
        <!-- Step 2 Node -->
        <div class="step-node" :class="step === 2 ? 'active' : ''" @click="if (document.getElementById('packageMainForm').querySelector('[name=title]').reportValidity() && document.getElementById('packageMainForm').querySelector('[name=price]').reportValidity()) step = 2;">
            ...
            <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input required type="text" name="title" x-model="title" placeholder="The Ultimate Bali Escape" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="w-full bg-[#F5F5F5] rounded-2xl p-4 flex flex-wrap items-center gap-2 border border-transparent focus-within:bg-white focus-within:ring-2 focus-within:ring-primary/25 transition-all">
                        <template x-for="(city, idx) in cities" :key="idx">
                            <span class="px-3.5 py-1.5 text-white rounded-full text-xs font-bold flex items-center gap-1.5 shadow-sm bg-primary" style="background-color: #e85d26 !important; color: #ffffff !important;">
            ...
            <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-4">
                            <input type="number" min="1" x-model="nights" @input="updateDurationFromNights" class="w-1/3 bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" placeholder="Enter nights" />
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div class="relative">
                                ...
                                <input type="text" x-model="validity_from" x-ref="validityFromPicker" placeholder="From Date" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 pl-10 pr-4 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                            </div>
                            <div class="relative">
                                <i data-lucide="calendar" size="16" class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400"></i>
                                <input type="text" x-model="validity_to" x-ref="validityToPicker" placeholder="To Date" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 pl-10 pr-4 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="group_size" x-model="group_size" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="departure_city" placeholder="New Delhi" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                    </div>

                    <!-- Sightseeing Details -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-1">Sightseeing Details (comma-separated)</label>
                        <input type="text" name="sightseeing" placeholder="e.g. 4 Sightseeing" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                    </div>

                    <!-- Departure State -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-1">Departure State</label>
                        <input type="text" name="departure_state" placeholder="Delhi" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm" />
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer select-none">
                        <input type="checkbox" name="hide_price" x-model="hidePrice" class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary/25 cursor-pointer" />
                ...
                <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            <select name="theme" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="holiday_type" class="w-full bg-[#F5F5F5] border-none rounded-2xl py-4 px-6 outline-none focus:ring-2 focus:ring-primary/25 transition-all font-bold text-foreground text-sm">
                ...
                <div class="flex-1 bg-white rounded-[28px] border border-gray-100 p-6 space-y-3 shadow-sm flex flex-col">
                    ...
                    <div class="flex-1 bg-[#F8F8F8] rounded-2xl overflow-hidden border border-gray-100 flex flex-col">
                        <div class="flex items-center gap-1 px-4 py-2.5 border-b border-gray-200 bg-white">
                            <button type="button" onclick="itineraryFormat('bold')" title="Bold" class="w-7 h-7 rounded-md flex items-center justify-center text-sm font-black text-gray-500 hover:bg-orange-50 hover:text-primary transition-all">B</button>
                            <button type="button" onclick="itineraryFormat('italic')" title="Italic" class="w-7 h-7 rounded-md flex items-center justify-center text-sm italic font-black text-gray-500 hover:bg-orange-50 hover:text-primary transition-all">I</button>
                            <div class="w-px h-4 bg-gray-200 mx-1"></div>
                            <button type="button" onclick="itineraryFormat('list')" title="Bullet list" class="w-7 h-7 rounded-md flex items-center justify-center text-gray-500 hover:bg-orange-50 hover:text-primary transition-all">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>
                            </button>
                            <button type="button" onclick="itineraryFormat('link')" title="Insert link" class="w-7 h-7 rounded-md flex items-center justify-center text-gray-500 hover:bg-orange-50 hover:text-primary transition-all">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="bg-[#FFF5F0] rounded-2xl p-5 space-y-3">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#F0642F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <button type="button" @click="if(newTransfer.trim()){transfers.push(newTransfer.trim()); newTransfer='';}" class="w-10 h-10 shrink-0 text-white rounded-xl text-sm font-bold flex items-center justify-center shadow-sm hover:opacity-90 transition-opacity bg-primary" style="background-color: #e85d26 !important; color: white !important;">+</button>
                                </div>
                            </div>
                            ...
                            <div class="bg-[#FFF5F0] rounded-2xl p-5 space-y-3">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#F0642F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 4v16"/><path d="M2 8h20"/><path d="M22 4v16"/><rect x="6" y="12" width="4" height="4"/><rect x="14" y="12" width="4" height="4"/></svg>
                    ...
                    <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-6 shadow-sm">
                        ...
                        <div class="space-y-4">
                            <label class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl cursor-pointer hover:bg-gray-100/60 transition-all">
                                ...
                                <input type="checkbox" name="amenities[]" value="Free Wifi" class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary/25 cursor-pointer" />
                            </label>
                            ...
                            <label class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl cursor-pointer hover:bg-gray-100/60 transition-all">
                                ...
                                <input type="checkbox" name="amenities[]" value="Breakfast Included" class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary/25 cursor-pointer" />
                            </label>
                            ...
                            <label class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl cursor-pointer hover:bg-gray-100/60 transition-all">
                                ...
                                <input type="checkbox" name="amenities[]" value="Travel Insurance" class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary/25 cursor-pointer" />
                            </label>
<label class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl cursor-pointer hover:bg-gray-100/60 transition-all">
                                <div class="flex items-center gap-3">
                                ...
                                <input type="checkbox" name="amenities[]" value="Private Chef Included"  class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary/25 cursor-pointer" />
                            </label>
                            ...
                            <label class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl cursor-pointer hover:bg-gray-100/60 transition-all">
                                ...
                                <input type="checkbox" name="amenities[]" value="Tour Manager Included"  class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary/25 cursor-pointer" />
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[32px] border border-gray-100 p-8 space-y-8 shadow-sm">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="file" name="image_file" x-ref="mainImageInput" class="hidden" accept="image/*" @change="previewUrl = URL.createObjectURL($event.target.files[0]); document.getElementById('image_url').value = '';" />
                                    <div class="text-[10px] text-gray-400 font-bold text-center">OR</div>
                                    <button type="button" class="w-full px-4 py-2 bg-orange-50 hover:bg-orange-100 text-primary border border-orange-200 rounded-xl font-bold text-xs shadow-sm transition-all" @click="openGalleryModal('main')">
                                        Choose from Gallery
                                    </button>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                                ...
                                <div class="aspect-[4/3] rounded-2xl border-2 border-dashed border-orange-200 hover:border-primary/50 transition-all flex flex-col items-center justify-center cursor-pointer bg-orange-50/30 hover:bg-orange-50/60" @click="openGalleryModal('gallery')">
        ...
        <div class="flex items-center justify-between pt-8 border-t border-gray-100 mt-8">
            ...
            <div class="flex items-center gap-3 ml-auto">
                ...
                <button type="button" @click="if (document.getElementById('packageMainForm').querySelector('[name=title]').reportValidity() && document.getElementById('packageMainForm').querySelector('[name=price]').reportValidity()) step = 2;" x-show="step === 1" class="px-8 py-3.5 bg-primary hover:bg-orange-600 text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-xl shadow-orange-700/20" style="background-color: #e85d26 !important; color: #ffffff !important;">
                    Save & Next
                </button>
    ...
    <div x-show="isGalleryModalOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" style="display: none;">
        <div class="bg-white rounded-[32px] w-full max-w-4xl max-h-[80vh] flex flex-col shadow-2xl overflow-hidden" @click.away="closeGalleryModal()">
            <div class="flex items-center justify-between p-6 border-b border-gray-100">
                <h3 class="text-lg font-black text-gray-800">Select Image from Gallery</h3>
                <button type="button" @click="closeGalleryModal()" class="text-gray-400 hover:text-red-500 transition-colors">
                    <i data-lucide="x" size="24"></i>
                </button>
            </div>
            
            <div class="p-6 bg-gray-50 border-b border-gray-100 flex items-center gap-2">
                <button type="button" @click="fetchGallery()" class="text-sm font-bold text-gray-500 hover:text-primary transition-colors flex items-center gap-1">
                ...
                <template x-for="(crumb, idx) in galleryBreadcrumbs" :key="idx">
                    <div class="flex items-center gap-2">
                        ...
                        <button type="button" @click="fetchGallery(crumb.id)" class="text-sm font-bold text-gray-500 hover:text-primary transition-colors" x-text="crumb.name"></button>
                    </div>
                </template>
            </div>
                ...
                <div class="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                    <template x-for="folder in galleryFolders" :key="folder.id">
                        <div class="group cursor-pointer" @click="fetchGallery(folder.id)">
                            <div class="aspect-square bg-gray-50 rounded-2xl border border-gray-100 flex flex-col items-center justify-center hover:bg-orange-50 hover:border-orange-200 transition-all">
                                <i data-lucide="folder" size="32" class="text-yellow-400 mb-2"></i>
                                <span class="text-xs font-bold text-gray-700 truncate w-full text-center px-2" x-text="folder.name"></span>
                            </div>
                        </div>
                    </template>

                    <template x-for="img in galleryImages" :key="img.id">
                        <div class="group cursor-pointer relative aspect-square rounded-2xl overflow-hidden border border-gray-100 hover:border-primary transition-all" @click="selectGalleryImage(img)">
                            <img :src="'/' + img.file_path" class="w-full h-full object-cover" />
                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                <span class="px-3 py-1 bg-white rounded-full text-xs font-bold text-gray-800">Select</span>
                            </div>
                        </div>
                    </template>
                    
                    <div x-show="galleryFolders.length === 0 && galleryImages.length === 0" class="col-span-full py-12 text-center text-gray-400">
