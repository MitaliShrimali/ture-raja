...
class CmsPagesSeeder extends Seeder
{
  ...
  array (
    ...
    'slug' => 'about-us',
    'content' => '<p>Welcome to <span class="font-bold text-black">www.tour raja.com</span> [“Tour raja”] – your trusted platform connecting travel agents with customers through seamless brochure uploads and easy access to contact details.</p>
...
<p class="mt-4 font-bold text-black">Join Tour raja today and experience the convenience of connecting, sharing, and discovering travel options with ease.</p>',
    'status' => 'Published',
    'created_at' => '2026-08-22 06:48:41',
    'updated_at' => '2026-08-22 06:48:41',
  ),
  1 => 
  array (
    'id' => 2,
    ...
    'status' => 'Published',
    'created_at' => '2026-08-12 12:33:35',
    'updated_at' => '2026-08-12 12:33:35',
  ),
  2 => 
  array (
    'id' => 3,
    ...
    'status' => 'Published',
    'created_at' => '2026-08-22 06:51:05',
    'updated_at' => '2026-08-22 06:51:05',
  ),
  3 => 
  array (
    'id' => 4,
    ...
    'content' => '<p>Preventive Measures:</p><p>Secure payment gatewaysVerification of customer identity and documents Monitoring unusual booking or transaction patterns Reporting suspicious activity immediately Customer Responsibility: Use only official Tour Raja channels</p><p><br></p><p>Do not share login credentials or payment details with third parties</p><p><br></p><p>Report suspicious emails, calls, or offers claiming to be Tour Raja</p><p><br></p><p>Company Action:</p><p><br></p><p>Investigate reported fraud cases</p><p><br></p><p>Suspend or terminate accounts involved in fraudulent activity</p><p><br></p><p>Cooperate with law enforcement when required</p><p><br></p><p>👉 The tone is usually&nbsp;</p>',
    'status' => 'Published',
    'created_at' => '2026-08-22 06:08:05',
    'updated_at' => '2026-08-22 06:28:56',
  ),
  4 => 
  array (
    'id' => 5,
    ...
    'content' => '<p>Listing accuracy policy content goes here.</p>',
    'status' => 'Published',
    'created_at' => '2026-08-22 06:08:05',
    'updated_at' => '2026-08-22 06:08:05',
  ),
  5 => 
  array (
    'id' => 6,
    ...
    'content' => '<p>Intellectual property content goes here.</p>',
    'status' => 'Published',
    'created_at' => '2026-08-22 06:08:05',
    'updated_at' => '2026-08-22 06:08:05',
  ),
  ...
  array (
    'id' => 7,
    'title' => 'Connect purchase terms',
    'slug' => 'connect-purchase-terms',
    'content' => '<p>Connect purchase terms content goes here.</p>',
    'status' => 'Published',
    'created_at' => '2026-08-22 06:08:05',
    'updated_at' => '2026-08-22 06:08:05',
  ),
  ...
  array (
    ...
    'updated_at' => '2026-08-22 06:48:41',
        ...
        foreach ($pages as $page) {
            unset($page['id']);
            DB::table('cms_pages')->updateOrInsert(['slug' => $page['slug']], $page);
        }
    }
}
